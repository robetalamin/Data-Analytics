...
#================================================================================
# 2ND CHECK FOR ERRORS OR MISLEADING INFORMATION
#================================================================================
...
cyclistic_trip_data <-
  select(
    ...
    -month, -check_length, -check_length_1m, 
...
ggplot() + 
  ...
  scale_y_continuous(name = "Number of Trips", 
                     ...
                     sec.axis = sec_axis(~./8000, name = "Temperature (°C)")) +
  theme(axis.text.x = element_text(angle = 45, hjust=1),
...
### bike type popularity per user type
ggplot(cyclistic_trip_data, aes(x = user_type, fill= bike_type)) +
  geom_bar(position="stack") + 
  theme(axis.text.x = element_text(angle = 45, hjust=1)) +
